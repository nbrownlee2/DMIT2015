...
public class Gmail {
	 ...
	 * @param password
	 *            The password of the username of the Gmail account.
	 */
	 ...
	 * 
	 * @param from
	 *            Any email address. Gmail mail server will replaced it with the
	 ...
	 * @throws Exception
	 *             There was an error communicating with the Gmail server.
	 */
